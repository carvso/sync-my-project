...
export const translations = {
  en: {
    ...
    contact: {
      title: 'Contact',
      titleHighlight: 'Me',
      description: "I'm available to discuss opportunities in Customer Support, Customer Service, or Tech Support. Don't hesitate to contact me for any questions or to schedule an interview.",
  ...
  it: {
    ...
    contact: {
      title: 'Contatta',
      titleHighlight: 'mi',
      description: 'Sono disponibile per discutere opportunità in Customer Support, Customer Service o Tech Support. Non esitare a contattarmi per qualsiasi domanda o per organizzare un colloquio.',
  ...
  es: {
    ...
    contact: {
      title: 'Contácta',
      titleHighlight: 'me',
      description: 'Estoy disponible para discutir oportunidades en Customer Support, Customer Service o Tech Support. No dudes en contactarme para cualquier pregunta o para programar una entrevista.',
